...
#include <memory>
#include "../../cs351_assignment4_gabriel_warkentin/chatapp.h"
...
QT_MOC_LITERAL(65, 10), // "changeInIp"
QT_MOC_LITERAL(76, 11), // "textEntered"
QT_MOC_LITERAL(88, 9) // "swapPorts"

    },
    "ChatApp\0sendMessage\0\0text\0changeInPort\0"
    "changeOutPort\0changeOutIp\0changeInIp\0"
    "textEntered\0swapPorts"
};
...
void ChatApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->changeInIp((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->textEntered(); break;
        case 6: _t->swapPorts(); break;
        default: ;
        }
        ...
        {
            using _t = void (ChatApp::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatApp::changeInIp)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void ChatApp::changeInIp(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
